  ...
  return (
    <div className="min-h-screen bg-[#07090D] flex flex-col md:flex-row text-slate-100">
      ...
      <main className="flex-1 flex flex-col overflow-y-auto">
        ...
        {/* Top Header Bar for easy logout & quick web access */}
        <header className="bg-[#0A0E17]/90 backdrop-blur-md border-b border-slate-800/80 px-6 py-3.5 flex items-center justify-between z-20 sticky top-0">
          <div className="flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
            <span className="text-xs font-semibold text-slate-300">Panel de Control AutoMaestro</span>
          </div>
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/"
              target="_blank"
              className="bg-slate-900 hover:bg-slate-800 text-slate-300 hover:text-white text-xs font-semibold px-3.5 py-2 rounded-xl border border-slate-700/80 flex items-center gap-1.5 transition-colors"
            >
            ...
            <button
              onClick={handleLogout}
              className="bg-rose-950/40 hover:bg-rose-600 text-rose-400 hover:text-white text-xs font-bold px-3.5 py-2 rounded-xl border border-rose-800/60 flex items-center gap-2 transition-all shadow-md shadow-rose-950/40"
            >
